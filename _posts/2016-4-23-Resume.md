...
Original code link: http://pastebin.com/vgyMQfek
```html
<!DOCTYPE HTML>
<html>
<body>
...
Modified function: (also on GitHub at https://github.com/ElliotHume/Shopicruit-tasks/blob/master/Shopify2.html)
```html
<!DOCTYPE HTML>
<html>
